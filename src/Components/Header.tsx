...
const logo = require("../Assets/you.png");
type Props = {};
...
function Header({}: Props) {
  ...
  return (
    <div className=" flex flex-wrap sm:flex-row gap-5 items-center justify-between drop-shadow-md bg-gradient-to-r from-myBlue to-myPink px-5 py-5 md:py-2 text-white rounded-5">
      <img
        className="w-[80px] drop-shadow-md cursor-pointer rounded-100"
        src={logo}
        alt="logo"
      />
